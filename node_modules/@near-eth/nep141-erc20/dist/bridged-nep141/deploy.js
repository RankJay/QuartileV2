 ...
 */
async function deployBridgeToken({ erc20Address, options }) {
    var _a, _b;
    options = options !== null && options !== void 0 ? options : {};
    const bridgeParams = utils_1.getBridgeParams();
    const nep141Factory = (_a = options.nep141Factory) !== null && _a !== void 0 ? _a : bridgeParams.nep141Factory;
    const nearAccount = (_b = options.nearAccount) !== null && _b !== void 0 ? _b : await utils_1.getNearAccount();
    if (typeof window !== 'undefined')
        utils_2.urlParams.set({ bridging: erc20Address });
    ...
    const tx = await nearAccount.functionCall({
        ...
        gas: new bn_js_1.default(3e13).mul(new bn_js_1.default(2)),
        ...
        attachedDeposit: new bn_js_1.default('302' + '0'.repeat(22))
    });
    return tx;
}
exports.default = deployBridgeToken;
