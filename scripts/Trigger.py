...
def check():
    ...
    for indx in range(0, len(DMCheckIDs)):
        ...
        if 'mint' in DMCheckIDs[indx][1]:
            ...
            priceFeed = Quartile.chainlinkAPICall()[0]
            tweepyAPISession.send_direct_message(mentions[indx]._json['message_create']['sender_id'], 'Thank you for using our service, be noted of the latest price being ' + str(priceFeed) + '. Please check out on your payments here: ' + urlRedirect)
